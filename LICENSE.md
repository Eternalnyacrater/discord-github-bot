...
> Discord GitHub bot, commit PR issue notifications 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

🔔 &nbsp;**Push alerts** — every commit and push notified

🐛 &nbsp;**Issues** — new issues and comments instantly

🔀 &nbsp;**PRs** — pull request opened, merged, or closed

⭐ &nbsp;**Stars** — see when repos get starred

🚀 &nbsp;**CI/CD** — build pass/fail alerts

📊 &nbsp;**Digest** — daily repo activity summary
